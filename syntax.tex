...
Besides the verbs and conjunctions, pronouns are also relevant to the narrative. For each person,there are different pronouns whose inflection depends on multiple grammatical categories.
