...
The relative order of clitics is quite precisely defined. Thus, by adding a few rules, it should be possible to help the tool generate more natural sentences.
...
The \textbf{unnaturalness} occurs when a proper name is inserted in an inappropriate place in a sentence.
