...
This type of narrative mode is written in third-person, and the narrator is standing outside the story. The narrator can be considered an objective observer of the scene who describes what he sees. He has no information about the emotions or inner thoughts of the characters. \cite{docekalova} In addition to that, the narrator is free of opinions, and it is not his place to make any judgments.
...
As shown above, the narrator is in the role of a reporter. He gives testimony about what the characters are doing and how the environment looks. However, the reader gets no mention of the thoughts of neither the narrator nor the characters described.
...
As we can see, the narrator makes several judgments in this version and expresses his opinions. However, he has still no idea about the inner thoughts of the characters, and the subjective expressions are only his assumptions.
