...
The last rule is independant to the person, and it covers the processing of direct speech. The simplified assumption is that the direct speech is in quotes. Therefore, all the text found in quotes should be ignored during the conversion process.
